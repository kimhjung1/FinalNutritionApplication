...
public class AddMedicineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton closeBtn = findViewById(R.id.memoCloseBtn);         // 약 추가 창 닫기 버튼
        Button medicineSaveBtn = findViewById(R.id.memoSaveBtn);        // 약 정보 저장 버튼
    ...
    private void saveMedicineData() {
        String medicineName = ((EditText) findViewById(R.id.textView10)).getText().toString();
